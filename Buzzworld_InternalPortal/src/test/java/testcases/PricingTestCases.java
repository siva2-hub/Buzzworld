...
public class PricingTestCases extends App {
	...
	public void testCase1() throws Exception {
		...
		//
		price.verifyaAddSPItemsToQuotewithAccountType(
				"PRICING_011_VerifyaAddSPItemsToQuotewithAccountType_withOutFixedPrice", "Discount", 17, "43", "", "",
				env);
		//
	...
	// boolean res =price.verifyBuyPrice_SellPrice_InSpecialPricing("Markup", 49,
	// "34", "","", 1);
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// // App.login();
	// //VerifyBuyPrice_SellPrice_InSpecialPricing_BuyPrice_PurchaseDiscounts_Null
	// boolean res =price.verifyBuyPrice_SellPrice_InSpecialPricing("Markup", 29,
	// "", "","", 2);
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// //VerifyBuyPrice_SellPrice_InSpecialPricing_BuyPrice_PurchaseDiscounts_Not_Null
	// boolean res =price.verifyBuyPrice_SellPrice_InSpecialPricing("Markup", 19,
	// "39", "","267", 3);
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// //VerifyBuyPrice_SellPrice_InSpecialPricing_BuyPrice_PurchaseDiscounts_Not_Null
	// boolean res =price.verifyBuyPrice_SellPrice_InSpecialPricing("Discount", 27,
	// "39", "","123", 4);
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// // App.login();
	// boolean res =
	// price.verifyaAddSPItemsToQuotewithAccountType("PRICING_010_VerifyaAddSPItemsToQuotewithAccountType_withFixedPrice","Markup",
	// 17, "43", "201.23","");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// boolean res =
	// price.verifyaAddSPItemsToQuotewithAccountType("PRICING_011_VerifyaAddSPItemsToQuotewithAccountType_withOutFixedPrice","Discount",
	// 17, "43", "","");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// boolean res = price.verifyAAddProduct_DuplicateStockCode(1, "0165029SS",
	// "BACO55", "178.9", "BA05");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// boolean res = price.verifyAAddProduct_DuplicateStockCode(2, "", "BACO55",
	// "178.9", "BA05");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// boolean res = price.verifyAAddProduct_DuplicateStockCode(3, "0165029SS",
	// "jhdfjdshfjbds", "178.9", "BA05");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	// @Test(enabled = false)
	...
	// App.login();
	// boolean res = price.verifyAAddProduct_DuplicateStockCode(4, "0165029SS",
	// "BACO55", "", "BA05");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// boolean res = price.verifyAAddProduct_DuplicateStockCode(5, "0165029SS",
	// "BACO55", "fdsfbdsfjbds", "BA05");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	// @Test(enabled = false)
	...
	// App.login();
	// boolean res = price.verifyAAddProduct_DuplicateStockCode(6, "0165029SS",
	// "BACO55", "125.23", "krishna naidu");
	// Assert.assertTrue(res);
	// App.logout();
	// }
	// @Test(enabled = false)
	...
	// App.login();
	// boolean res =
	// price.isDifferentPricing("PRICING_020_Verify_isDifferentPricing_CheckBox_Yes_InVendors",
	// true);
	// Assert.assertTrue(res);
	// App.logout();
	// }
	...
	// App.login();
	// boolean res =
	// price.isDifferentPricing("PRICING_021_Verify_isDifferentPricing_CheckBox_No_InVendors",
	// false);
	// Assert.assertTrue(res);
	// App.logout();
	// }
